...
export declare function prepend(el: HTMLElement, newEl: HTMLElement): void;
export declare function insertAfter<T extends Element>(newChild: T, refChild: Element): T;
